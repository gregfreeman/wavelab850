...
% -------------------------------------------------------
LastFigureNo = 5;
PaperName = 'Wavelet Threshold Estimators for Data with Correlated Noise';
MakeFigureFilePrefix = 'corfig';
% NRfigures = {1};
% CRfigures = {8,10,11};
...
uicontrol(  'style','pushbutton',  'units','normal', ...
    ...
    'fontsize',fs, 'callback','CorrelDemo(''CloseAllDemo'')');
